...
from myprojectprototype.app import views
from myprojectprototype.script import bikeinfo, weatherinfo, processmanagement, currentweatherinfo
...
def main():
    ...
    if sys.argv[1] == 'webstart':
        ...
        runInParallel(bikeinfo.main, weatherinfo.main, currentweatherinfo.main)
    elif sys.argv[1] == 'allstart':
        runInParallel(bikeinfo.main, weatherinfo.main, currentweatherinfo.main, webserver_func)
